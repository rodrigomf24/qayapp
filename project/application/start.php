...
Autoloader::map(array(
	...
	'Tools'             => Bundle::path('system').'tools.php',
	'AuthAdapter'       => Bundle::path('system').'auth_adapter.php',
	'DbService'         => Bundle::path('system').'db_service.php',
	'AdminHelpers'      => Bundle::path('system').'admin_helpers.php',
));
